...
class itinerario(models.Model):
    ...
    cant_dias_itinerario = models.IntegerField(null=False,verbose_name="cantidad dias")
    ciudad_destino_itinerario = models.CharField(max_length=20,null=False,verbose_name="ciudad destino")
    id_publico_itinerario =  models.IntegerField(null=False,verbose_name="id publico")
